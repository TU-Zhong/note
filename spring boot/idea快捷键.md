...
2、<mark style="background: #FFF3A3A6;">光标定位及选中快捷键</mark>
...
3、<mark style="background: #FFF3A3A6;">删除/插入相关快捷键</mark>
...
4、<mark style="background: #FFF3A3A6;">文件之间定位相关快捷
 </mark>
...
5、<mark style="background: #FFF3A3A6;">查找相关快捷键</mark>
...
特别说明：当光标不处于代码编辑窗口时，直接输入键盘字母，idea会智能的对当前活动窗口下的内容进行查找，very nice!
————————————————

                            版权声明：本文为博主原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接和本声明。
                        
原文链接：https://blog.csdn.net/tang9140/article/details/52333601